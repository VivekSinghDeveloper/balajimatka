	...
	<!-- Zero Configuration  Starts-->	
		<div class="col-sm-12">
			<div class="card">
			  ...
			  <a class="btn btn-primary btn-sm btn-float" href="#addgalidisswargameModal" role="button" data-toggle="modal">Add Game </a></h4>
				  <table class="table table-striped table-bordered" id="galidisswargameList">
					<thead>
					  <tr>
						<th>#</th>
						<th>Game Name</th>
...
<div class="modal fade" id="addgalidisswargameModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal_right_side" role="document">
	<div class="modal-content col-12 col-md-5">
	  ...
	  <div class="modal-body">
		<form class="theme-form" id="addgalidisswargamegameFrm" name="addgalidisswargamegameFrm" method="post" >
			<div class="row">
...
<div class="modal fade" id="galidisawaroffdayModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal_right_side" role="document">
	<div class="modal-content col-12 col-xl-4">
	  ...
	  <div class="modal-body galidisawar_modal_off_day">
</div>
</div>
</div>
</div>
