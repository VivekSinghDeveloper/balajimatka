		...
		<form class="theme-form" id="updateeditgalidisswargameFrm" name="updateeditgalidisswargameFrm" method="post" >
			<div class="row">
				...
				<div class="form-group col-6">
                            <label  for="open_time">Open Time</label>
                              ...
                              <input name="open_time" id="up_open_time" class="form-control digits" value="<?php  echo $open_time; ?>" type="time" >
                            
                </div>
                <?php /*<div class="form-group col-6">
                            <label for="close_time">Close Time</label>
                              <input name="close_time" id="up_close_time" class="form-control digits" type="time" value="<?php if(isset($close_time)){ echo $close_time; } ?>">
