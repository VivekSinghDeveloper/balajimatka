		...
		<div class="col-sm-12 col-xl-12 col-md-12">
            ...
            <div class="row">
				...
				<div class="col-sm-12">
                    ...
                    <div class="card">
						<div class="card-body">
							<h5>Winning Report</h5>

							<form class="theme-form mega-form" id="galidisswarWinningReportFrm" name="galidisswarWinningReportFrm" method="post">
								...
								<div class="form-group col-md-2">
									...
									<div class="date-picker">
										...
										<div class="input-group">
										  ...
										  <input class="form-control digits" type="date" data-language="en" value="<?php echo $date;?>" name="result_date" id="result_date"  max="<?php echo $date;?>">
